...
const regexPasswordValidation = /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])[0-9a-zA-Z]{8,}$/;

const formInputReducer = (state, action) => (action.type.includes('USER_INPUT')
  ? {
    value: action.val,
      ...
      <div className={styles.wrapper}>
        ...
        <form>
          ...
          <div className={styles.pass}>
            <h6 className={styles.password_reset}>

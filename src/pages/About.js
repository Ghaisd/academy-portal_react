...
import styles from './About.module.css'
    ...
    const  iconAchievements = [ "bi bi-check-square-fill", "bi bi-people-fill", "bi bi-award-fill", "bi bi-trophy-fill" ];
    const  finishedAchievements = [ "runder gjennomført", "studenter starter", "som fullførte", "av disse jobber i dag innen IT" ];
...
<section className={styles.about__achievements}>
    <div className={`${styles.container} ${styles['about__achievements-container']}`}>

        <div className={styles['about__achievements-left']}>
            <img src="/images/about_achievements.svg" style={{top: '10rem'}} alt="achievement"/>
        </div>
        ...
        <div className={styles['about__achievements-right']}>
            ...
            <h1>Resultater</h1>
            <p>
                Vi jobber for å få folk ut av NAV-systemet og inn i helt nye karrierer, og det på rekordtid. Det er ikke småtteri. Vi er mange som er med på å gjøre dette mulig, det være seg den eminente foreleseren fra Nederland, et fantastisk samarbeid med ildsjeler i NAV, våre egne mentorer fra Ikomm, praksisbedrifter, og mest av alt, kandidatene selv som griper denne sjansen med blod, svette, og tårer. Vi er stolte over de resultatene vi sammen har oppnådd med Ikomm Academy, her er de mest synlige av dem.
                <strong>I tillegg</strong> er vi veldig godt i gang med den tredje gjennomføringen av Ikomm Academy. Det er i år 7 studenter, og ting fungerer bedre enn noen gang. Til høsten gleder vi oss til å presentere mange nye IT-talenter til samfunnet.
            </p>

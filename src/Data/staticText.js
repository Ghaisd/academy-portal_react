...
export const staticTextAbout = {
  achievementsSectionTextP: `Vi jobber for å få folk ut av NAV-systemet og inn i helt nye
   ...
   I tillegg er vi veldig godt i gang med den tredje

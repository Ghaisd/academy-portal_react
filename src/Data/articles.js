export const articles = [
  {
    ...
    ImageLInk: "/images/Article1.jpg",
    CanPublish: true,
    IsPublished: true,
    DateOfCreate: {
      $date: {
        $numberLong: "1653221212043",
      },
    },
  },
  {
    ...
    ImageLInk: "/images/Homage til Erik.png",
    CanPublish: true,
    IsPublished: true,
    DateOfCreate: {
      $date: {
  ...
  },
  {
    ...
    AuthorId: 33466,
    AuthorName: "Argyro",
    AuthorImageLink: "/images/iro.jpg",
    ...
    ImageLInk: "/images/dotnet.jpg",
    CanPublish: true,
    IsPublished: true,
    DateOfCreate: {
      $date: {
        $numberLong: "1653221852281",
      },
    },
  },
  {
    ...
    ImageLInk: "/images/Steffen Mini Project.png",
    CanPublish: true,
    IsPublished: true,
    DateOfCreate: {
      $date: {
        $numberLong: "1653296910545",
      },
    },
  },
  {
    ...
    ImageLInk: "/images/Breakdown Day.jpg",
    CanPublish: true,
    IsPublished: true,
    DateOfCreate: {
      $date: {
        $numberLong: "1653301373678",
      },
    },
  },
  {
    ...
    ImageLInk: "/images/Trivia Night.gif",
    CanPublish: true,
    IsPublished: true,
    DateOfCreate: {
      $date: {
